...
Run the following commands in two separate aterminals to create a blissful development experience where your browser
...
To optimize the LeaveManagementSystem application for production, run:
